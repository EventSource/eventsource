...
function EventSource (url, eventSourceInitDict) {
  ...
  function scheduleReconnect () {
    ...
    var isShortTermStrategyFinished = false
    ...
    shortTermRetryStrategy.attempt(function (currentAttempt) {
      ...
      isShortTermStrategyFinished = true
    })
    ...
    var isMediumTermStrategyFinished = false
    ...
    mediumTermStrategy.attempt(function (currentAttempt) {
      if (isShortTermStrategyFinished) {
        ...
        isMediumTermStrategyFinished = true
      }
    })
    ...
    longTermStrategy.attempt(function (currentAttempt) {
      if (isMediumTermStrategyFinished) {
