...
function EventSource(url, eventSourceInitDict) {
  ...
  function connect() {
    ...
    if (eventSourceInitDict && eventSourceInitDict.timeout && isPlainObject(eventSourceInitDict.timeout)) {
        options.timeout = eventSourceInitDict.timeout;
    }
    req = (isSecure ? https : http).request(options, function (res) {
      ...
      if (res.statusCode == 301 || res.statusCode == 307) {
        ...
        readyState = EventSource.CONNECT_ERROR;
...
Object.defineProperty(EventSource, 'CONNECT_ERROR', { enumerable: true, value: 1});
Object.defineProperty(EventSource, 'OPEN', { enumerable: true, value: 2});
Object.defineProperty(EventSource, 'CLOSED', { enumerable: true, value: 3});
