...
Dropped support for Node.js versions below 22.19), as it is no longer maintained. While there are no explicit changes that makes it incompatible, we make no guarantees of it being supported going forward.
